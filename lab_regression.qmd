...
Select *simple scatterplot* from the first window that appears. Place `GADD` in the y-axis and `hyper` in the x-axis as shown in @fig-L3_scatter_options and click *OK* to generate your plot.
